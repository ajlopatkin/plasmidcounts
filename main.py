...
# parameters
contig_len_cutoff = 500      # min length for contigs to keep
mash_cutoff = 0.05           # mash distance to consider two contigs duplicate
plasfinder_cov = 80          # coverage threshold for plasmidfinder results
plasfinder_pid = 90          # pct ID threshold for plasmidfinder results
...
blast_len_thresh = 27000     # threshold for contig length to blast
overlap_cutoff_short = 0.01  # cutoff for overlap of blast results for short contigs
overlap_cutoff_long = 0.15   # cutoff for overlap of blast results for long contigs
blast_len_cutoff = 1000      # cutoff for plasmid length in PLSdb blast
filter_col = True            # flag to filter Col plasmids
